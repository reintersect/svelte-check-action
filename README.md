...
| `tsgo` | Hand TypeScript diagnostics to tsgo instead of the TypeScript JS API. Needs svelte-check >= 4.4; writes transpiled Svelte files to disk (`.svelte-kit` if present, else `.svelte-check`). | `false` |
